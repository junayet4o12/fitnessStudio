            ...
            <div className={`${!edit ? 'block' : 'hidden'} my-5 relative`}>
                ...
                <div className={`${edit && 'hidden'} absolute top-5 right-5`}>
                        <button
                            ...
                            className=' border-2 border-primary py-[5px] px-1 sm:px-3 font-bold  transition-all rounded hover:rounded-md bg-white/90  hover:bg-primary/90 hover:text-white duration-300 active:scale-90 active:rounded-xl flex justify-center items-center gap-1 text-sm sm:text-base'><span className='text-sm font-bold'><FaRegPenToSquare /></span>Edit <span className='hidden xs:block'>Profile</span></button>
                    </div>
            </div>
            <div className={`${edit ? 'block' : 'hidden'}`}>
                <div className='w-full max-w-7xl  bg-secondary/40   mx-auto p-5 pt-12 rounded relative shadow-lg  '>
