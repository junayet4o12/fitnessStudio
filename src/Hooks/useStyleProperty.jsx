...
const inputStyle = "peer border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5  text-sm font-normal text-gray-700 outline outline-0 placeholder-shown:border-blue-gray-200 focus:border-gray-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 placeholder:opacity-0 focus:placeholder:opacity-100";
