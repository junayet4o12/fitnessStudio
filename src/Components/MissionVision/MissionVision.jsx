    ...
    <div>
        <div className="mission and vision section my-[50px]">
          <div className="flex flex-col items-center">
           ...
           <span className="specialFont text-secondary"> & </span>
           Vision</h1>
           <div className='bg-secondary h-[4px] w-[90%] lg:w-[25%] rounded-lg'></div>
          </div>
          <div className="missionSection flex flex-col lg:flex-row gap-2 my-[25px] items-center ">
            ...
            <div className="lg:w-[50%] flex flex-col gap-2">
              ...
              <div className='bg-secondary h-[4px] w-[30%] lg:w-[25%] rounded-lg'></div>
