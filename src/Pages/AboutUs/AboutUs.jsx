  ...
  return (
    <div className="mt-[50px] p-[10px]" >
      ...
      <div className="intro lg:flex justify-evenly items-center">
        ...
        <h1 className=" text-2xl lg:text-5xl font-bold my-[15px] ">About <span className="text-primary" >FitnessStudio</span></h1>
        <p className="font-[500]">Welcome to our inclusive <span className="text-primary font-bold">Fitnessstudio</span>, where certified trainers offer personalized <span className="text-primary font-bold">workouts </span>, including HIIT, yoga, and strength conditioning. Whether you're a fitness enthusiast or beginner, we're here to support your journey to improved health and wellness in a motivating atmosphere. Join us to redefine your fitness experience and achieve your <span className="text-primary font-bold">goals.</span></p>
        </div>
        <div className="lg:w-[50%]">
      ...
      <div>
        <div className="mission and vision section my-[50px]">
          <div className="flex flex-col items-center">
           ...
           <spna className="specialFont text-primary"> & </spna>
           Vision</h1>
           <div className='bg-primary h-[4px] w-[90%] lg:w-[25%] rounded-lg'></div>
          </div>
          <div className="missionSection flex flex-col lg:flex-row gap-2 my-[25px] items-center ">
            ...
            <div className="lg:w-[50%] flex flex-col gap-2">
              ...
              <div className='bg-primary h-[4px] w-[30%] lg:w-[25%] rounded-lg'></div>
        ...
        <div className="storyBehind bg-primary p-[25px] bg-opacity-[0.6] min-h-[350px] justify-center rounded-tl-[50px] rounded-br-[50px] flex flex-col items-center gap-2 text-white text-center">
        ...
        <div className="ourTeam my-[50px]">
          <div className="member flex flex-col justify-center gap-2 items-center">
            ...
            <div className='bg-primary h-[4px] w-[90%] lg:w-[20%] rounded-lg'></div>
            <div className="flex flex-col md:flex-row flex-wrap gap-5 justify-evenly items-center">
              <div className="my-[20px] border-4 border-white hover:border-primary hover:ease-out duration-[0.5s] flex flex-col items-center shadow-xl w-[90%] lg:w-[30%] rounded-md cursor-pointer p-[20px]">
                <img className="h-[100px] object-cover" src={devImg} alt="devImg"/>
                <h1 className="font-[500] text-xl">Jobayer Ahmed Sajid</h1>
                <h1 className="font-[500] text-primary">Team Leader</h1>
              </div>
              <div className="my-[20px] border-4 border-white hover:border-primary hover:ease-out duration-[0.5s] flex flex-col items-center shadow-xl w-[90%] lg:w-[30%] rounded-md cursor-pointer p-[20px]">
                <img className="h-[100px] object-cover" src={devImg} alt="devImg"/>
                <h1 className="font-[500] text-xl">Jobayer Rahman Ohee</h1>
                <h1 className="font-[500] text-primary">Developer</h1>
              </div>
              <div className="my-[20px] border-4 border-white hover:border-primary hover:ease-out duration-[0.5s] flex flex-col items-center shadow-xl w-[90%] lg:w-[30%] rounded-md cursor-pointer p-[20px]">
                <img className="h-[100px] object-cover" src={devImg} alt="devImg"/>
      ...
      <div className="faq flex flex-col gap-2 justify-center items-center lg:mx-[25px]">
        ...
        <div className='bg-primary h-[5px] w-[50%] lg:w-[15%] rounded-lg'></div>
        <div className="my-[25px] flex lg:gap-2 flex-col md:flex-row">
        <div className="faq-1">
          <div className="collapse border-2 bg-primary my-[8px] text-white">
