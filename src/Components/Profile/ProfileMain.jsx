...
const ProfileMain = ({ age, myBMI, myBMR, userDetails }) => {
    ...
    return (
        <div className='max-w-7xl mx-auto'>
            <div className='profile-Status-Section w-full mx-auto flex  flex-col sm:flex-row justify-center items-center sm:items-center sm:justify-start   py-7 gap-5  lg:gap-10 p-4 bg-gradient-to-br from-primary/80 via-primary/60 to-primary/30 rounded my-5 shadow-2xl px-10'>
