...
const AboutIntro = () => {
  return (
    <div className="intro lg:flex justify-evenly items-center">
        ...
        <p className="font-[500]">Welcome to our inclusive <span className="text-[#ff4704] font-bold">Fitnessstudio</span>, where certified trainers offer personalized <span className="text-[#ff4704] font-bold">workouts </span>, including HIIT, yoga, and strength conditioning. Whether you&apos;re a fitness enthusiast or beginner, we&lsquo;re here to support your journey to improved health and wellness in a motivating atmosphere. Join us to redefine your fitness experience and achieve your <span className="text-[#ff4704] font-bold">goals.</span></p>
        </div>
        <div className="lg:w-[50%]">
