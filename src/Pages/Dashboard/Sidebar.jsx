...
const Sidebar = () => {
  ...
  return (
    <div
      className="scroolBar min-w-56  min-h-screen max-h-screen  hidden md:block sticky top-0 text-white overflow-y-auto scroll-smooth"
      style={{ scrollbarWidth: "thin", scrollbarColor: "#888 #f1f1f1" }}>
      <div
        className="scroolBar min-w-56  min-h-screen max-h-screen  
     hidden md:block sticky top-0 overflow-y-auto scroll-smooth bg-[#000428] "
        style={{ scrollbarWidth: "thin", scrollbarColor: "#888 #f1f1f1" }}>
