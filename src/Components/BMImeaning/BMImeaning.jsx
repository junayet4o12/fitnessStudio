...
const BMImeaning = () => {
  return (
    <div>
        <div className='flex flex-col md:flex-row items-center gap-2 justify-evenly md:w-[80%] mx-auto my-[50px]'>
        ...
        <div className='bg-secondary md:w-[90%] bg-opacity-[0.2] my-[100px] rounded-tr-[20px] rounded-br-[20px]  p-[25px] flex flex-col md:flex-row gap-5'>
