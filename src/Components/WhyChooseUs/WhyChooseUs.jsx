...
const WhyChooseUs = () => {
  return (
    <div className='flex flex-col md:flex-row justify-evenly items-center container mx-auto'>
        <div className='bg-primary p-[15px] text-white md:w-[70%] min-h-[400px] flex flex-col justify-center gap-2'>
        ...
        <div className='hidden md:flex flex-wrap gap-2 w-full md:w-fit md:ml-[-20%]'>
            <div className='bg-secondary text-white text-xl p-[10px] w-[30%] md:w-[25%] text-center font-[600] flex flex-col items-center justify-center h-[200px]'>
