...
const Sidebar = () => {
  ...
  return (
    <div className="scroolBar min-w-56  min-h-screen max-h-screen bg-[#000428] hidden md:block sticky top-0 text-white overflow-y-auto scroll-smooth" style={{ scrollbarWidth: 'thin', scrollbarColor: '#888 #f1f1f1' }}>
