...
import { FaHome, FaIdCard, FaList, FaPhoneAlt, FaUserAlt } from "react-icons/fa";
        ...
        <div className="flex">
            ...
            <div className="w-60 min-h-screen bg-primary">
                <ul className="menu p-4">
                    ...
                    <li><button onClick={handleLogout} className="p-3 bg-orange-600 text-white"> Log Out</button></li>
                </ul>
            </div>
            {/* dashboard contant */}
