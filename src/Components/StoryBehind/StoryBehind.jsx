...
const StoryBehind = () => {
  return (
    <div className="storyBehind bg-secondary p-[25px] bg-opacity-[0.6] min-h-[350px] justify-center rounded-tl-[50px] rounded-br-[50px] flex flex-col items-center gap-2 text-white text-center">
