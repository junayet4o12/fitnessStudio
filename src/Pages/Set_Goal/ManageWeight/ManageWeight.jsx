...
const ManageWeight = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (
      selectedValue?.value === "gainWeight" &&
      userCurrentWeight > data?.targetWeight
    ) {
      return Swal.fire({
        icon: "error",
        title: "Oops...",
        ...
        footer:
          '<a href="#">Set the target weight correctly and try again!!</a>',
      });
    } else if (
      selectedValue?.value === "lossWeight" &&
      userCurrentWeight < data?.targetWeight
    ) {
      return Swal.fire({
        icon: "error",
      ...
      selectedValue?.value === "maintainWeight" &&
      userCurrentWeight !== data?.targetWeight
    ) {
      return Swal.fire({
        icon: "error",
